...
Go create a [Personal access token on GitLab](https://docs.gitlab.com/ee/user/profile/personal_access_token.html) (only requires `read_api` access), and make entry in `.env` file located in your root application directory:
